function buildMetadata(samples) {
  ...
  var sample_metadata = data.sample_metadata;
  //console.log(sample_metadata);
  //Filter the data for the object with the desired sample number
  var resultArray = sample_metadata.filter(sampleObj => sampleObj.id == samples.otu_ids);
...
function buildCharts(samples) {
  ...
  // var url1 = `./static/js/samples.json`;
  ...
  // @TODO: Build a Bubble Chart using the sample data
    var xval = samples.otu_ids;
    var yval = samples.sample_values;
    var msize = samples.sample_values;
    var mcolor = samples.otu_ids;
    var tval = samples.otu_labels;
...
function init() {
  ...
  d3.json("samples.json").then((sampleNames) => {
    ...
    // console.log(sampleNames.samples[0])
